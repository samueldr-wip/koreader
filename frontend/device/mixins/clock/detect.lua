...
local clock_timedatectl = require("device/mixins/clock/timedatectl")
local clock_hwclock = require("device/mixins/clock/hwclock")
local clock_none = function() end

return function(class)
		logger.info("mixins/clock/detect: Detecting clock backend...")
